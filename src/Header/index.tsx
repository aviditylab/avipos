...
export default function Header() {
  ...
  return (
    <div className='flex justify-between items-center'>
      ...
      <div className='p-3 cursor-pointer' onClick={openSidebar}>
        <GiHamburgerMenu className=' text-primary text-2xl' />
      </div>
      <div ref={sidebar}
        className="sidebar fixed top-0 bottom-0 right-0 lg:right-0 p-2 w-[300px] overflow-y-auto text-center bg-gray-900"
      >
        <div className="text-gray-100 text-xl">
          <div className="p-2.5 mt-1 flex items-center">
            <i className="bi bi-app-indicator px-2 py-1 rounded-md bg-blue-600"></i>
            <h1 className="font-bold text-gray-200 text-[15px] ml-3">TailwindCSS</h1>
            <HiX className="text-white text-2xl ml-auto cursor-pointer" onClick={closeSidebar} />
          </div>
